...
- **Forwards compatibility for Kong 3 route paths** - Kong 3 introduces a breaking change to the route path format, in which regex paths require a tilde (`~`) prefix. To ensure API provider readiness for this upgrade, warnings will be issued when publishing incompatible routes. More information can be found in our [Kong 3 Transition Guide](https://developer.gov.bc.ca/docs/default/component/aps-infra-platform-docs/unlisted/kong3-upgrade/).